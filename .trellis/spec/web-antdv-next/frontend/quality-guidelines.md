# web-antdv-next Quality Guidelines
...
## ant-design-vue v4 风格 Notes

- Use ant-design-vue v4 符合 framework idiomatic patterns
- Don't mix Reactive frameworks(Vue 3 only here)
- Theme 切换: prefer `<ant-design-vue v4ConfigProvider>` over manual CSS
