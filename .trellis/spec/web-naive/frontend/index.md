...
> vben monorepo package `@vben/web-naive` (v5.7.0) — HolOS built with this package and customized config.

## Overview

Application package **@vben/web-naive** — a vite-based frontend app for the vben monorepo.
...
## Conventions for @vben/web-naive
