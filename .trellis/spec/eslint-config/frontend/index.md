...
⚠️ **Placeholder spec.** No actual package named `eslint-config` exists in the workspace yet. 本文件 was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
