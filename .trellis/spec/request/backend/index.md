...
⚠️ **Placeholder spec.** No actual package named `request` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Request workspace (`@vben/request`) — `requestClient`, axios wrapper, SSO helpers.
