...
⚠️ **Placeholder spec.** No actual package named `composables` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Composables workspace (`@vben-core/composables`) — `useScroll`, `useScrollbar`, etc.
