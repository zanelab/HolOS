...
⚠️ **Placeholder spec.** No actual package named `plugins` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Plugins workspace (`@vben/plugins`) — vite plugin adapters (vue, html, mock, etc).
