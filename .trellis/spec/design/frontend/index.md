...
⚠️ **Placeholder spec.** No actual package named `design` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Design tokens (Tailwind preset, color, spacing, typography) — base design language. Located at `@vben-core/design`.
