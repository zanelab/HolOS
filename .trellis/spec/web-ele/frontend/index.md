...
> vben monorepo package `@vben/web-ele` (v5.7.0) — HolOS built with this package and customized config.

## Overview

Application package **@vben/web-ele** — a vite-based frontend app for the vben monorepo.
