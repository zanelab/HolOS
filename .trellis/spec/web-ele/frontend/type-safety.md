...
## element-plus Type Patterns

```ts
import type { ButtonProps, SelectProps } from 'element-plus';
...
- ❌ Don't bypass strict mode for element-plus libs (forward issues to maintainer)
