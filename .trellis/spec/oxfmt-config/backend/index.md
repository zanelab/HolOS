...
⚠️ **Placeholder spec.** No actual package named `oxfmt-config` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> OxFmt config (Rust-based formatter, fast replacement for Prettier).
