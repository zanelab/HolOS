...
⚠️ **Placeholder spec.** No actual package named `@core` exists in the workspace yet. 本文件 was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Core workspace packages (`@vben-core/*`) — UI primitives shared across the vben monorepo. Combines base, typings, composables, design tokens, form/layout/menu/popup/shadcn/tabs UIs.
