...
⚠️ **Placeholder spec.** No actual package named `effects` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Effects workspace packages (`@vben/effects/*`) — hooks, layouts, plugins, request, common-ui, access, mock backends.
