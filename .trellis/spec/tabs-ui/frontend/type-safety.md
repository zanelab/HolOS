...
### 1. Generic utility types (core of `@vben-core/tabs-ui` for typings role)
...
pnpm typecheck --filter @vben-core/tabs-ui       # this package only
```
...
- ❌ Don't re-export types from `node_modules` directly — wrap with a
  `@vben-core/tabs-ui`-scoped alias.
