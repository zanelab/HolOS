...
⚠️ **Placeholder spec.** No actual package named `layout-ui` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Layout UI primitives — `VbenLayout`, `LayoutSidebar`, `LayoutHeader`, `LayoutTabbar`, `LayoutContent`, `LayoutFooter`.
