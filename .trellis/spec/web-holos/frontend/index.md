...
> vben monorepo package `@vben/web-holos` (v5.7.0) — HolOS built with this package and customized config.

## Overview

Application package **@vben/web-holos** — a vite-based frontend app for the vben monorepo.
...
## Conventions for @vben/web-holos
