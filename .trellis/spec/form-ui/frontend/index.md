...
⚠️ **Placeholder spec.** No actual package named `form-ui` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Form UI primitives — input wrappers, validators, integration with adapters (antd/tdesign/naive/ele).
