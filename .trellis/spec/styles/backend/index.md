...
> vben monorepo package `@vben/styles` (v5.7.0) — HolOS built with this package and customized config.

## Overview

Package **@vben/styles** (v5.7.0) — vben monorepo shared library.

- **Version**: 5.7.0
- **Type**: module
- **Scripts**: (no scripts)
- **Deps** (top): @vben-core/design
...
- ❌ Don't introduce new build configurations in this directory — extend the base config from `@vben/styles`
