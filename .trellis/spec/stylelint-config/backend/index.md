...
⚠️ **Placeholder spec.** No actual package named `stylelint-config` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
