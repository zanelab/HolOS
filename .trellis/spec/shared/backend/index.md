...
⚠️ **Placeholder spec.** No actual package named `shared` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Shared workspace (`@vben-core/shared`) — runtime constants (ELEMENT_ID_*), bootstrap tokens, generic helpers.
