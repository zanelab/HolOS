...
⚠️ **Placeholder spec.** No actual package named `typings` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Typings workspace (`@vben-core/typings`) — generic TS types (ComponentRecord, Recordable, etc).
