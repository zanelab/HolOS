...
⚠️ **Placeholder spec.** No actual package named `common-ui` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Common UI components — fallback pages, AuthenticationLoginExpiredModal, profile/about components (located in `_core/` of apps).
