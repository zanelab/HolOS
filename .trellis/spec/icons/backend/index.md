...
> vben monorepo package `@vben/icons` (v5.7.0) — HolOS built with this package and customized config.

## Overview

Package **@vben/icons** (v5.7.0) — vben monorepo shared library.
...
- ❌ Don't introduce new build configurations in this directory — extend the base config from `@vben/icons`
