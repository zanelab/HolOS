...
⚠️ **Placeholder spec.** No actual package named `layouts` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Layouts workspace (`@vben/layouts`) — BasicLayout, AuthenticationLayout, IFrameView.
