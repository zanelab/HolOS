...
> vben monorepo package `@vben/vsh` (v5.7.0) — HolOS built with this package and customized config.

## Overview

Package **@vben/vsh** (v5.7.0) — vben monorepo shared library.

- **Version**: 5.7.0
- **Type**: module
- **Scripts**: stub
- **Deps** (top): @vben/node-utils, cac, circular-dependency-scanner, knip, publint
...
- ❌ Don't introduce new build configurations in this directory — extend the base config from `@vben/vsh`
