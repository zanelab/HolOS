...
⚠️ **Placeholder spec.** No actual package named `playground` exists in the workspace yet. This file was auto-generated by Trellis init to ensure AI agents don't hallucinate conventions for unknown packages.
...
> Placeholder package in vben monorepo. Real package does not exist yet — this spec is here so AI agents know the conventions for this name. If a package is created later, replace this placeholder with real conventions.
