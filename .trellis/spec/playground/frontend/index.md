...
> Placeholder package in vben monorepo. 真实 package does not exist yet — this spec is here so AI agents know the conventions for this name. If a package is created later, replace this placeholder with real conventions.
