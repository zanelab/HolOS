...
> vben monorepo package `@vben/turbo-run` (v5.7.0) — HolOS built with this package and customized config.

## Overview

Package **@vben/turbo-run** (v5.7.0) — vben monorepo shared library.
...
## Conventions for @vben/turbo-run
...
- ❌ Don't introduce new build configurations in this directory — extend the base config from `@vben/turbo`
